...
import lecture2.model.Drawing;
import lecture2.model.Shape;
import lecture2.sound.MidiSynth;
import lecture2.ui.tools.*;
...
// the main class instanciates a new drawing editor which basically represents the window
// reusability of code can be seen with the abstract of a tool - where there are several tools with the same
