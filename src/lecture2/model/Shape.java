package lecture2.model;


import lecture2.sound.MidiSynth;
...
public class Shape {
    ...
    //           If the lecture2.sound associated with the new y-coordinate is different, play the new lecture2.sound
    ...
    // MODIFIES: this
    // EFFECTS:  selects this Shape, plays associated lecture2.sound
    ...
    // MODIFIES: this
    // EFFECTS:  unselects this Shape, stops playing associated lecture2.sound
    ...
    // EFFECTS: starts playing this Shape, where lecture2.sound is dependent on the area/coordinates of the Shape
    private void play() {
